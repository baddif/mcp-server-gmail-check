#!/usr/bin/env python3
"""
Version Management for Gmail Check MCP Server

This module provides version information and update utilities for the
Gmail Check MCP Server project.
"""
...
VERSION_INFO = {
    ...
    "Example inspector and Claude Desktop configs"
...
def get_version_string() -> str:
    ...
    """
    return f"Gmail Check MCP Server v{__version__} (MCP {__compatibility_version__})"
